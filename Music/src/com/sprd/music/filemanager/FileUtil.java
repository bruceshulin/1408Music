...
/*        File sdDir = new File("/sdcard");
    ...
    public static boolean isSupportType(Context context, File file) {
        ...
        if (lower.endsWith(".mp3") || lower.endsWith(".m4a")
                ...
                || lower.endsWith(".flac") // SPRD: add for bug 328044
                /* SPRD 433943 @{ */
                //|| lower.endsWith(".3gpp")) {
                // SPRD 437301
                || lower.endsWith(".3gpp") || (lower.endsWith(".mp4") && recordingType(context,file))) {
                /* @} */
            return true;
        }
        isSupportDRMType(context,file);
        return false;
    }
    /* SPRD 433943 @{ */
    // SPRD 437301
    ...
    public static boolean isSupportDRMType(Context context, File file) {
        return false;
    }
}
