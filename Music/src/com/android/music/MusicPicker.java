...
public class MusicPicker extends ListActivity
    ...
    public void onCreate(Bundle icicle) {
        ...
        //SPRD :add mount and unmount listener for bug 222471
        registerSDListener();
    ...
    Cursor doQuery(boolean sync, String filterstring) {
        ...
        /* SPRD: Add for bug 252016:some no-support files are not displayed in the playlist @{ */
    ...
    /*
     * SPRD: bugfix 275992 play song in MusicPicker in focus strategy to solve
     * audio conflict @{
     */
