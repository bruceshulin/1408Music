...
/* verson@sprdrise 20150730 add superpower */
import android.provider.Settings;
import android.os.SystemProperties;
/* verson@sprdrise 20150730 */
/**
 * 
 */
public class MediaButtonIntentReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
		...
		/* verson@sprdrise 20150730 add superpower */
		if(SystemProperties.getBoolean("ro.sprdrise.superpower",false)
			&& Settings.Global.getInt(context.getContentResolver(),Settings.Global.SUPER_POWER, 0)==1){
			return;
		}
		/* verson@sprdrise 20150730 */
