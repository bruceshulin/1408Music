    ...
    private View.OnClickListener mOpenClicked = new View.OnClickListener() {
        public void onClick(View v) {
            ...
            if (name != null && name.length() > 0) {
                /* SPRD: when playlist is named to Recently added ,it will be toasted@{ */
                ...
                Uri uri;
                if (id >= 0) {
                    /* SPRD: Remove original code for adding dialog when button is set overwrited@{ */
