...
public class RenamePlaylist extends Activity
{
    ...
    private int idForplaylist(String name) {
        ...
        if (c != null) {
            ...
            //SPRD: close cursor if the cursor is not null.
            c.close();
            c = null;
        }
        //SPRD:remove
    ...
    private View.OnClickListener mOpenClicked = new View.OnClickListener() {
        public void onClick(View v) {
            ...
            if (name != null && name.length() > 0) {
                /*
                 * SPRD: add for bug 365809 when playlist is renamed to Recently
                 * added ,it will be toasted @{
                 */
                if (name.equals(getString(R.string.recentlyadded))) {
                  ...
                  /*
                   *
                   *when Playlist name unmodified the prompt
                   */
                if(mOriginalName!=null && mOriginalName.equals(name)){
                     setResult(RESULT_OK);
                     Toast.makeText(RenamePlaylist.this, R.string.playlist_Unmodified, Toast.LENGTH_SHORT).show();
                     finish(); 
                     return;
                 }
                /* SPRD: modify for bug 279221 */
                if (mOriginalName == null || !mOriginalName.equals(name)) {
