...
public class MediaPlaybackService extends Service {
    ...
    /* SPRD: notify update when service onDestroy*/
    ...
    // SPRD: add for bug 327877 @{
    private static final int PLAY_FORMAT_ERROR = 8;
    // SPRD: add for bug 327877 @}
    private static final int MAX_HISTORY_SIZE = 100;
    // SPRD: add for bug 381226 @}
    private boolean mSetNextPlayerEnable = false;
    /*  SPRD: Bug 430579 Music player couldn't fast forward with Bluetooth @{ */
    ...
    //jianhui.li@transsion.com add butto on statusbar 20151016
    ...
    // SPRD: update for bug 279691, prevent duplicate requestAudioFocus
    private boolean mPlayFromFocusGain = false;
    // SPRD: update for bug 385382, prevent duplicate requestAudioFocus
    ...
    private Handler mMediaplayerHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            /* SPRD: fix bug 381729 - monkey exception @{ */
            if (mPlayer == null) {
            ...
            switch (msg.what) {
                ...
                case TRACK_WENT_TO_NEXT:
                    ...
                    // SPRD Add current playing track to history, so that it can not set current track to be next player
                ...
                case TRACK_ENDED:
                    ...
                    if (mRepeatMode == REPEAT_CURRENT) {
                        /* SPRD: add for bug381226, disable setNextPlayer @{ */
                ...
                case FOCUSCHANGE:
                    ...
                    switch (msg.arg1) {
                        ...
                        case AudioManager.AUDIOFOCUS_GAIN:
                            ...
                            if(!isPlaying() && mPausedByTransientLossOfFocus) {
                                ...
                                mMediaplayerHandler.removeMessages(NOTIFICATION);
                            }
                            break;
                        default:
                    ...
                    break;
                /* SPRD: fix bug 327877 - monkey exception @{ */
                ...
                /* @} */
                case NOTIFICATION:
                    /* SPRD: bug 263317 refresh statusbar with common method */
                    updateNotification();
                    break;
                /* SPRD: fix bug 327877 - monkey exception @} */
                default:
    ...
    private BroadcastReceiver mIntentReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (CMDNEXT.equals(cmd) || NEXT_ACTION.equals(action)) {
                ...
                /* SPRD: fix bug 327763 Do not start MediaPlaybackService before boot complete*/
    ...
    public void onDestroy() {
       Log.d(LOGTAG, "onDestroy");
        ...
        //SPRD : add for unregisterReceiver
        unregisterReceiver();
        ...
        mWakeLock.release();
        //SPRD:  add for clear the notification when the service restart
        stopForeground(true);
        cancelNotification();
        super.onDestroy();
    }
    ...
    public void closeExternalStorageFiles(String storagePath) {
        ...
        notifyChange(QUEUE_CHANGED);
        notifyChange(META_CHANGED);
        /* SPRD 393225 remove 351227's patch @{
        // SPRD:add for bug 351227 when music stop by changing status of sd card
        // ,the services should be destroy
        //stopSelf(mServiceStartId);
        /* @} */
        Log.d(LOGTAG, "closeExternalStorageFiles stopself");
    }
            ...
            mUnmountReceiver = new BroadcastReceiver() {
                ...
                public void onReceive(Context context, Intent intent) {
                    ...
                    if (action.equals(Intent.ACTION_MEDIA_EJECT)) {
                        ...
                        notifyChange(QUEUE_CHANGED);
                        notifyChange(META_CHANGED);
                        /* SPRD: abandonAudioFocus and reset playing state after player stoped for bug 281780 @{ */
                        mAudioManager.abandonAudioFocus(mAudioFocusListener);
    ...
    private void notifyChange(String what) {
        ...
        /* SPRD 408846 hide notification when player stop @{ */
    ...
    private void openCurrentAndNext() {
        synchronized (this) {
            ...
            if (mPlayListLen == 0) {
                /// SPRD: if the playlist be empty,clear the history to avoid these files can not
            ...
            /* @} */
            stop(false);
            Log.i(LOGTAG,"openCurrentAndNext mPlayListLen = " + mPlayListLen +"mPlayPos = " +mPlayPos);
            mCursor = getCursorForId(mPlayList[mPlayPos]);
            while(true) {
                ...
                if (mOpenFailedCounter++ < 10 &&  mPlayListLen > 1) {
                    ...
                    if (pos < 0) {
                        gotoIdleState();
                        /* SPRD: add for bug382878, when open last song fail, show play error @{ */
    ...
    private void setNextTrack() {
        ...
        /* @} */
        //when current player has been initialized we can set next media player to current player
        ...
        /*
         * playlist's length is 1 with shuffle nomal mode,need not set the
         * nextplayerjust return, to avoid it will be play twice.
         */
    ...
    public boolean open(String path) {
        synchronized (this) {
            ...
            /* SPRD: add player status check avoid NullPointerException bug 378368 @{ */
            if (mPlayer != null) {
    ...
    public void play() {
        ...
        if (!mPlayFromFocusGain && !mPlayFromFocusCanDuck) {
            /* SPRD: requestAudioFocus fail will return, bug 282209 @{ */
    ...
    private void updateNotification() {
        ...
        /* SPRD: fix bug 389481, remove the judging condition @{ */
        /*  if (getAudioId() < 0) {
            // streaming
            mStatusBarViews.setTextViewText(R.id.trackname, getPath());
            mStatusBarViews.setTextViewText(R.id.artistalbum, null);
        } else {*/
        /* @} */
       ...
       // }
        //jianhui.li@transsion.com add button on statusbar 20151016
        Intent intent = new Intent();
        PendingIntent pendingIntent = null;
        intent.setAction(PREVIOUS_ACTION);
        pendingIntent = PendingIntent.getBroadcast(this, 0, intent, 0);
        mStatusBarViews.setOnClickPendingIntent(R.id.control_pre, pendingIntent);
        intent.setAction(NEXT_ACTION);
        pendingIntent = PendingIntent.getBroadcast(this, 0, intent, 0);
        mStatusBarViews.setOnClickPendingIntent(R.id.control_next, pendingIntent);
        intent.setAction(TOGGLEPAUSE_ACTION);
        pendingIntent = PendingIntent.getBroadcast(this, 0, intent, 0);
        mStatusBarViews.setOnClickPendingIntent(R.id.control_play, pendingIntent);
        if(isPlaying()){
            mStatusBarViews.setImageViewResource(R.id.control_play, R.drawable.ic_appwidget_music_pause);
            Log.d("out","music is play");
        } else{
            mStatusBarViews.setImageViewResource(R.id.control_play, R.drawable.ic_appwidget_music_play);
        }
    ...
    private void stop(boolean remove_status_icon) {
        Log.i(LOGTAG,"stop remove_status_icon (" + remove_status_icon + ")");
        if (mPlayer != null && mPlayer.isInitialized()) {
            mPlayer.stop();
        }
        mFileToPlay = null;
        ...
        /* SPRD: bug 392273 Need not to stop foreground every time call stop(false), because it will make music proirty become
         * low and may be retrieved by ActivityManager.Such as when Music is playing background and user
         * remove Music from app list,then play next song, music will be retrieved.  */
        /*else {
    ...
    public void prev() {
        synchronized (this) {
            /* SPRD: delete ,remove this to the function of getPrePosition  @{
            ...
            //SPRD: set prev status for prev fail
            mIsPrev = true;
            saveBookmarkIfNeeded();
            stop(false);
            openCurrentAndNext();
    ...
    private int getNextPosition(boolean force) {
        Log.i(LOGTAG,"getNextPosition(" + force + ")" + "mRepeatMode = " + mRepeatMode + "mShuffleMode = " +mShuffleMode);
       if (mRepeatMode == REPEAT_CURRENT) {
        ...
        if (mShuffleMode == SHUFFLE_NORMAL) {
            ...
            /// SPRD: move to gotoNext() for only add to history when gotoNext @{
    ...
    public void gotoNext(boolean force) {
        synchronized (this) {
            ...
            /* SPRD: add get the postion of next song by user when the repeatmode is REPEAT_CURRENT @{ */
            if (mRepeatMode == REPEAT_CURRENT) {
            ...
            if (pos < 0) {
                gotoIdleState();
                // SPRD 413639 reset to start position
                seek(0);
                if (mIsSupposedToBePlaying) {
                    mIsSupposedToBePlaying = false;
                    notifyChange(PLAYSTATE_CHANGED);
                }
                /* SPRD: restore mPlayPos for bug 272801 @{ */
                mPlayPos = resetPos;
                /* @} */
                return;
            }
    ...
    private int removeTracksInternal(int first, int last) {
        synchronized (this) {
            ...
            if (gotonext) {
                if (mPlayListLen == 0) {
                    /* SPRD 401264,if delete the last playing music file,
                     * the player will stop and reset,but the notification still show,
                     * so need hide notification @{ */
                    stopForeground(true);
                    /* @} */
                    stop(true);
                    mPlayPos = -1;
    ...
    public void setShuffleMode(int shufflemode) {
        synchronized(this) {
            ...
            /*
             * SPRD: when set party shuffle or shuffle all at
             * repeat current, we should set repeat mode to repeat none to avoid
             * repeat current exist same with party shuffle and shuffle mode.@{
             */
    ...
    public long duration() {
        /* SPRD 414282 add null point judgment @{ */
        if (mPlayer != null && mPlayer.isInitialized()) {
        //if (mPlayer.isInitialized()) {
        /* @} */
    ...
    private class MultiPlayer {
        ...
        public void setNextDataSource(String path) {
            ...
            if (setDataSourceImpl(mNextMediaPlayer, path)) {
                ...
                // SPRD add :updata path for nexttrack in lrc
    ...
    /**
     * Returns the _data of the currently playing file, or empty if no file is
     * currently playing.
     */
    public String getAudioData() {
