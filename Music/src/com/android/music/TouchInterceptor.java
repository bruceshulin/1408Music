...
public class TouchInterceptor extends ListView {
    ...
    // SPRD: Bug 396632 - We use it to record.
    private View mView;
    ...
    private void doExpansion() {
        ...
        for (int i = 0;; i++) {
            ...
            if (mDragPos < numheaders && i == numheaders) {
                ...
                // instead
                if (vv.equals(first)) {
                    // SPRD: Bug 396632 - We record this view and restore its visibility when
                    // stopDrag.
                    mView = vv;
                ...
                if (mDragPos == mSrcDragPos || getPositionForView(vv) == getCount() - 1) {
                    ...
                    // SPRD: Bug 390415 - Item has been set INVISIBLE when dragging starts but not
                    // restored when dragging ends on 5.0. So we do not set it INVISIBLE when
                    // dragging starts.
                    // SPRD: Bug 396632 - We record this view and restore its visibility when
                    // stopDrag.
                    mView = vv;
    ...
    private void stopDragging() {
        ...
        // SPRD: Bug 396632 - Restore visibility.
        if (mView != null) {
